    ...
    //дописать
{
    public class DataSeeder
    {
        ...
        public void Initial()
        {
            ...
            new Game { Team1Name = "England", Team2Name = "Scotland", Team1Score = 0, Team2Score = 0, Status = Status.Start },
            new Game { Team1Name = "Germany", Team2Name = "France", Team1Score = 0, Team2Score = 0, Status = Status.Start },
